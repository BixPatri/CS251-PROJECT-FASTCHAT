...
GRANT SELECT("ID") ON TABLE public."Clients" TO "Client";
...
GRANT SELECT("Name") ON TABLE public."Clients" TO "Client";


--
-- Name: COLUMN "Clients"."Public Key"; Type: ACL; Schema: public; Owner: postgres
--

GRANT SELECT("Public Key") ON TABLE public."Clients" TO "Client";
...
--
-- Name: TABLE "Server Info"; Type: ACL; Schema: public; Owner: postgres
--
